...
<li><a href="http://admissions.iit.edu">IIT Admissions</a></li>
 ...
 <aside id="side-content">
        ...
        <ol id="news">
          <li><a href="#">Article 1</a><div><p>This is an article about Penguins</p></div></li>
          <li><a href="#">Article 2</a><div><p>Preview of very interesting article article about space and fish</p></div></li>
          <li><a href="#">Article 3</a><div><p>Preview of my mothers cookbook</p></div></li>
          <li><a href="#">Article 4</a><div><p>A very interesting article article on the number 5</p></div></li>
        </ol>
      </aside>
    </main>
    <footer id="footer">
